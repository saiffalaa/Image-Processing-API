...
app.get('/api', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        ...
        options = { root: 'D:/runJs/src/server' };
        if (fileHeight && fileWidth) {
            if (checkExist("D:/runJs/src/server/".concat(fileName, "-").concat(fileWidth, "x").concat(fileHeight, ".jpg"))) {
            ...
            if (checkExist("D:/runJs/src/server/".concat(fileName)))
